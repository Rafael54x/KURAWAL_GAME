        ...
        {selamat ? (
          ...
          <div className="relative text-black">
            ...
            <div className="flex justify-around my-12 m-4">
              ...
              style={{backgroundImage: `url(${bgmakanan})`}}>
                <h3 className="mt-4">Jumlah yang dimiliki : {makananPalembang1}</h3>
              ...
              <div className="grid place-items-center text-white w-[380px] h-[430px] mx-8 rounded-[24px]"
              style={{backgroundImage: `url(${bgmakanan})`}}>
                <h3 className="mt-4">Jumlah yang dimiliki : {makananPalembang2}</h3>
              ...
              <div className="grid place-items-center text-white w-[380px] h-[430px] mx-8 rounded-[24px]"
              style={{backgroundImage: `url(${bgmakanan})`}}>
                <h3 className="mt-4">Jumlah yang dimiliki : {makananPalembang3}</h3>
            ...
            <button className="text-white ml-8 text-4xl mt-8" onClick={handlePalembang}>Back to Home</button>
          </div>
        )}
      </div>
    </div>
