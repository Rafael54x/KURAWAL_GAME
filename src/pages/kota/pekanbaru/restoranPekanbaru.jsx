  ...
  const handlePekanbaru = () => {
    navigate("/pekanbaru", {
      state: {
        ...
        weather: weather,
        weatherId: weatherId,
        makananPekanbaru1: makananPekanbaru1,
        makananPekanbaru2: makananPekanbaru2,
        makananPekanbaru3: makananPekanbaru3,
      },
    });
  };
        ...
        {selamat ? (
          ...
          <div className="relative text-black">
            ...
            <div className="flex justify-around my-12 m-4">
              ...
              style={{backgroundImage: `url(${bgmakanan})`}}>
                <h3 className="mt-4">Jumlah yang dimiliki : {makananPekanbaru1}</h3>
              ...
              <div className="grid place-items-center text-white w-[380px] h-[430px] mx-8 rounded-[24px]"
              style={{backgroundImage: `url(${bgmakanan})`}}>
                <h3 className="mt-4">Jumlah yang dimiliki : {makananPekanbaru2}</h3>
              ...
              <div className="grid place-items-center text-white w-[380px] h-[430px] mx-8 rounded-[24px]"
              style={{backgroundImage: `url(${bgmakanan})`}}>
                <h3 className="mt-4">Jumlah yang dimiliki : {makananPekanbaru3}</h3>
            ...
            <button className="text-white ml-8 text-4xl mt-8" onClick={handlePekanbaru}>Back to Home</button>
          </div>
        )}
      </div>
    </div>
