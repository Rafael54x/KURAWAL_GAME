...
import bgmPekanbaru from "../../../audio/bsPekanbaru.mp3";
...
const Pekanbaru = () => {
  ...
  const audioRefPekanbaru = useRef(null);

  const handleBGM = () => {
    if (music){
      audioRefPekanbaru.current.play();
    }
  };
